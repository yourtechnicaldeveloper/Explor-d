...
export declare class AddButtonComponent implements AfterViewInit, OnChanges {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<AddButtonComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<AddButtonComponent, "[ng2-st-add-button]", never, { "grid": "grid"; "source": "source"; }, { "create": "create"; }, never, never>;
}
