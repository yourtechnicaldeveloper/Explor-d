...
export declare class CustomFilterComponent extends FilterDefault implements OnChanges, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<CustomFilterComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<CustomFilterComponent, "custom-table-filter", never, { "query": "query"; }, {}, never, never>;
}
