...
}(this, (function (exports,i0,_angular_common,rxjs,rxjs_operators,_angular_forms,_angular_router,_angular_cdk_a11y,_angular_cdk_portal,_angular_cdk_overlay,i1,_angular_platformBrowser,_angular_animations,intersectionObserver,_angular_cdk_bidi,_angular_cdk_table,_angular_cdk_keycodes) { 'use strict';
 ...
 */
const NB_THEME_OPTIONS = new i0.InjectionToken('Nebular Theme Options');
const NB_MEDIA_BREAKPOINTS = new i0.InjectionToken('Nebular Media Breakpoints');
const NB_BUILT_IN_JS_THEMES = new i0.InjectionToken('Nebular Built-in JS Themes');
const NB_JS_THEMES = new i0.InjectionToken('Nebular JS Themes');
/**
 * We're providing browser apis with tokens to improve testing capabilities.
 * */
const NB_WINDOW = new i0.InjectionToken('Window');
const NB_DOCUMENT = new i0.InjectionToken('Document');
...
class NbThemeService {
     ...
     */
    getJsTheme() {
        return this.onThemeChange().pipe(rxjs_operators.map((theme) => {
    ...
    onMediaQueryChange() {
        return this.changeWindowWidth$
            .pipe(rxjs_operators.startWith(undefined), rxjs_operators.pairwise(), rxjs_operators.map(([prevWidth, width]) => {
            return [
                this.breakpointService.getByWidth(prevWidth),
                this.breakpointService.getByWidth(width),
            ];
        }), rxjs_operators.filter(([prevPoint, point]) => {
            return prevPoint.name !== point.name;
        }), rxjs_operators.distinctUntilChanged(null, params => params[0].name + params[1].name), rxjs_operators.share());
    }
    /**
...
class NbLayoutScrollService {
    ...
    getPosition() {
        return rxjs.Observable.create((observer) => {
            const listener = new rxjs.Subject();
 ...
 * */
class NbFocusTrap extends _angular_cdk_a11y.FocusTrap {
...
class NbFocusTrapFactoryService extends _angular_cdk_a11y.FocusTrapFactory {
...
class NbFocusKeyManager extends _angular_cdk_a11y.FocusKeyManager {
}
...
class NbActiveDescendantKeyManager extends _angular_cdk_a11y.ActiveDescendantKeyManager {
}
...
class NbFocusMonitor extends _angular_cdk_a11y.FocusMonitor {
}
...
class NbPortalDirective extends _angular_cdk_portal.CdkPortal {
}
NbPortalDirective.decorators = [
    { type: i0.Directive, args: [{ selector: '[nbPortal]' },] }
];
class NbPortalOutletDirective extends _angular_cdk_portal.CdkPortalOutlet {
}
NbPortalOutletDirective.decorators = [
    { type: i0.Directive, args: [{ selector: '[nbPortalOutlet]' },] }
];
class NbComponentPortal extends _angular_cdk_portal.ComponentPortal {
}
class NbOverlay extends _angular_cdk_overlay.Overlay {
}
NbOverlay.decorators = [
    { type: i0.Injectable }
];
class NbOverlayPositionBuilder extends _angular_cdk_overlay.OverlayPositionBuilder {
}
NbOverlayPositionBuilder.decorators = [
    { type: i0.Injectable }
];
class NbTemplatePortal extends _angular_cdk_portal.TemplatePortal {
    constructor(template, viewContainerRef, context) {
        super(template, viewContainerRef, context);
    }
}
class NbOverlayContainer extends _angular_cdk_overlay.OverlayContainer {
}
NbOverlayContainer.decorators = [
    { type: i0.Injectable }
];
class NbFlexibleConnectedPositionStrategy extends _angular_cdk_overlay.FlexibleConnectedPositionStrategy {
}
class NbPortalInjector extends _angular_cdk_portal.PortalInjector {
}
const CDK_MODULES = [_angular_cdk_overlay.OverlayModule, _angular_cdk_portal.PortalModule];
/**
...
class NbPlatform extends i1.Platform {
}
...
class NbViewportRulerAdapter extends _angular_cdk_overlay.ViewportRuler {
    ...
    getViewportSize() {
        ...
        * */
        this.ruler.getDimensions()
            .pipe(rxjs_operators.map(dimensions => ({ width: dimensions.clientWidth, height: dimensions.clientHeight })))
    ...
    getViewportScrollPosition() {
        ...
        * */
        this.scroll.getPosition()
            .pipe(rxjs_operators.map((position) => ({ top: position.y, left: position.x })))
...
const VERTICAL_POSITIONS = [exports.NbPosition.BOTTOM, exports.NbPosition.TOP];
const HORIZONTAL_POSITIONS = [exports.NbPosition.START, exports.NbPosition.END];
...
class NbAdjustableConnectedPositionStrategy extends NbFlexibleConnectedPositionStrategy {
    constructor() {
        super(...arguments);
        this._offset = 15;
        this.positionChange = this.positionChanges.pipe(rxjs_operators.map((positionChange) => positionChange.connectionPair), rxjs_operators.map((connectionPair) => {
...
class NbGlobalPositionStrategy extends _angular_cdk_overlay.GlobalPositionStrategy {
    position(position) {
        switch (position) {
            case exports.NbGlobalLogicalPosition.TOP_START:
...
NbPositionedContainer.propDecorators = {
    ...
    topStart: [{ type: i0.HostBinding, args: ['class.nb-overlay-top-start',] }],
    topEnd: [{ type: i0.HostBinding, args: ['class.nb-overlay-top-end',] }],
    right: [{ type: i0.HostBinding, args: ['class.nb-overlay-right',] }],
    endTop: [{ type: i0.HostBinding, args: ['class.nb-overlay-end-top',] }],
    endBottom: [{ type: i0.HostBinding, args: ['class.nb-overlay-end-bottom',] }],
    bottom: [{ type: i0.HostBinding, args: ['class.nb-overlay-bottom',] }],
    bottomStart: [{ type: i0.HostBinding, args: ['class.nb-overlay-bottom-start',] }],
    bottomEnd: [{ type: i0.HostBinding, args: ['class.nb-overlay-bottom-end',] }],
    left: [{ type: i0.HostBinding, args: ['class.nb-overlay-left',] }],
    startTop: [{ type: i0.HostBinding, args: ['class.nb-overlay-start-top',] }],
    startBottom: [{ type: i0.HostBinding, args: ['class.nb-overlay-start-bottom',] }]
};
...
NbOverlayContainerComponent.propDecorators = {
    portalOutlet: [{ type: i0.ViewChild, args: [NbPortalOutletDirective, { static: true },] }]
};
...
class NbScrollDispatcherAdapter extends _angular_cdk_overlay.ScrollDispatcher {
 ...
 * */
class NbBlockScrollStrategyAdapter extends _angular_cdk_overlay.BlockScrollStrategy {
...
class NbScrollStrategyOptions extends _angular_cdk_overlay.ScrollStrategyOptions {
...
class NbClickTriggerStrategy extends NbTriggerStrategyBase {
    constructor() {
        ...
        this.click$ = rxjs.fromEvent(this.document, 'click')
            .pipe(rxjs_operators.map((event) => [!this.container() && this.isOnHost(event), event]), rxjs_operators.share(), rxjs_operators.takeUntil(this.destroyed$));
        this.show$ = this.click$
            .pipe(rxjs_operators.filter(([shouldShow]) => shouldShow), rxjs_operators.map(([, event]) => event), rxjs_operators.takeUntil(this.destroyed$));
        this.hide$ = this.click$
            .pipe(rxjs_operators.filter(([shouldShow, event]) => !shouldShow && !this.isOnContainer(event)), rxjs_operators.map(([, event]) => event), rxjs_operators.takeUntil(this.destroyed$));
    }
}
/**
 * Creates show and hide event streams.
...
class NbHoverTriggerStrategy extends NbTriggerStrategyBase {
    constructor() {
        super(...arguments);
        this.show$ = rxjs.fromEvent(this.host, 'mouseenter')
            .pipe(rxjs_operators.filter(() => !this.container()), 
        ...
        rxjs_operators.takeUntil(rxjs.fromEvent(this.host, 'mouseleave')), rxjs_operators.repeat(), rxjs_operators.takeUntil(this.destroyed$));
        this.hide$ = rxjs.fromEvent(this.host, 'mouseleave')
            .pipe(rxjs_operators.switchMap(() => rxjs.fromEvent(this.document, 'mousemove')
            .pipe(rxjs_operators.debounceTime(100), rxjs_operators.takeWhile(() => !!this.container()), rxjs_operators.filter(event => this.isNotOnHostOrContainer(event)))), rxjs_operators.takeUntil(this.destroyed$));
    }
}
/**
 * Creates show and hide event streams.
...
class NbFocusTriggerStrategy extends NbTriggerStrategyBase {
    constructor() {
        super(...arguments);
        this.focusOut$ = rxjs.fromEvent(this.host, 'focusout')
            .pipe(rxjs_operators.switchMap(() => rxjs.fromEvent(this.document, 'focusin')
            .pipe(rxjs_operators.takeWhile(() => !!this.container()), rxjs_operators.filter(event => this.isNotOnHostOrContainer(event)))), rxjs_operators.takeUntil(this.destroyed$));
        this.clickIn$ = rxjs.fromEvent(this.host, 'click')
            .pipe(rxjs_operators.filter(() => !this.container()), rxjs_operators.takeUntil(this.destroyed$));
        this.clickOut$ = rxjs.fromEvent(this.document, 'click')
            .pipe(rxjs_operators.filter(() => !!this.container()), rxjs_operators.filter(event => this.isNotOnHostOrContainer(event)), rxjs_operators.takeUntil(this.destroyed$));
        this.tabKeyPress$ = rxjs.fromEvent(this.document, 'keydown')
            .pipe(rxjs_operators.filter((event) => event.keyCode === 9), rxjs_operators.filter(() => !!this.container()), rxjs_operators.takeUntil(this.destroyed$));
        this.show$ = rxjs.merge(rxjs.fromEvent(this.host, 'focusin'), this.clickIn$)
            .pipe(rxjs_operators.filter(() => !this.container()), rxjs_operators.debounceTime(100), 
        // tslint:disable-next-line:rxjs-no-unsafe-takeuntil
        rxjs_operators.takeUntil(rxjs.fromEvent(this.host, 'focusout')), rxjs_operators.repeat(), rxjs_operators.takeUntil(this.destroyed$));
        this.hide$ = rxjs.merge(this.focusOut$, this.tabKeyPress$, this.clickOut$)
            .pipe(rxjs_operators.takeUntil(this.destroyed$));
    }
}
/**
...
class NbNoopTriggerStrategy extends NbTriggerStrategyBase {
    constructor() {
        super(...arguments);
        this.show$ = rxjs.EMPTY;
        this.hide$ = rxjs.EMPTY;
    }
}
...
NbIconComponent.propDecorators = {
    html: [{ type: i0.HostBinding, args: ['innerHtml',] }],
    primary: [{ type: i0.HostBinding, args: ['class.status-primary',] }],
    info: [{ type: i0.HostBinding, args: ['class.status-info',] }],
    success: [{ type: i0.HostBinding, args: ['class.status-success',] }],
    warning: [{ type: i0.HostBinding, args: ['class.status-warning',] }],
    danger: [{ type: i0.HostBinding, args: ['class.status-danger',] }],
    basic: [{ type: i0.HostBinding, args: ['class.status-basic',] }],
    control: [{ type: i0.HostBinding, args: ['class.status-control',] }],
    icon: [{ type: i0.Input }],
    pack: [{ type: i0.Input }],
...
NbCardComponent.propDecorators = {
    ...
    tiny: [{ type: i0.HostBinding, args: ['class.size-tiny',] }],
    small: [{ type: i0.HostBinding, args: ['class.size-small',] }],
    medium: [{ type: i0.HostBinding, args: ['class.size-medium',] }],
    large: [{ type: i0.HostBinding, args: ['class.size-large',] }],
    giant: [{ type: i0.HostBinding, args: ['class.size-giant',] }],
    primary: [{ type: i0.HostBinding, args: ['class.status-primary',] }],
    info: [{ type: i0.HostBinding, args: ['class.status-info',] }],
    success: [{ type: i0.HostBinding, args: ['class.status-success',] }],
    warning: [{ type: i0.HostBinding, args: ['class.status-warning',] }],
    ...
    basicAccent: [{ type: i0.HostBinding, args: ['class.accent-basic',] }],
    controlAccent: [{ type: i0.HostBinding, args: ['class.accent-control',] }]
};
...
NbCalendarComponent.propDecorators = {
    ...
    date: [{ type: i0.Input }],
    showWeekNumber: [{ type: i0.Input }],
    weekNumberSymbol: [{ type: i0.Input }],
...
NbButtonComponent.propDecorators = {
    ...
    filled: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.appearance-filled',] }],
    outline: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.appearance-outline',] }],
    ghost: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.appearance-ghost',] }],
    hero: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.appearance-hero',] }],
    fullWidth: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.full-width',] }],
    disabled: [{ type: i0.Input }, { type: i0.HostBinding, args: ['attr.aria-disabled',] }, { type: i0.HostBinding, args: ['class.btn-disabled',] }],
    ...
    basic: [{ type: i0.HostBinding, args: ['class.status-basic',] }],
    control: [{ type: i0.HostBinding, args: ['class.status-control',] }],
    rectangle: [{ type: i0.HostBinding, args: ['class.shape-rectangle',] }],
    round: [{ type: i0.HostBinding, args: ['class.shape-round',] }],
    semiRound: [{ type: i0.HostBinding, args: ['class.shape-semi-round',] }],
    iconLeft: [{ type: i0.HostBinding, args: ['class.icon-start',] }],
    iconRight: [{ type: i0.HostBinding, args: ['class.icon-end',] }],
...
NbCalendarDayCellComponent.propDecorators = {
    ...
    isLarge: [{ type: i0.HostBinding, args: ['class.size-large',] }],
    dayCellClass: [{ type: i0.HostBinding, args: ['class.day-cell',] }],
...
NbCalendarMonthCellComponent.propDecorators = {
    ...
    disabled: [{ type: i0.HostBinding, args: ['class.disabled',] }],
    isLarge: [{ type: i0.HostBinding, args: ['class.size-large',] }],
    monthCellClass: [{ type: i0.HostBinding, args: ['class.month-cell',] }],
    onClick: [{ type: i0.HostListener, args: ['click',] }]
};
    ...
    getText() {
        ...
        switch (this.viewMode) {
            case exports.NbCalendarViewMode.DATE: {
                const month = this.dateService.getMonthName(this.date, _angular_common.TranslationWidth.Wide);
...
NbCalendarPickerRowComponent.propDecorators = {
    ...
    size: [{ type: i0.Input }],
    select: [{ type: i0.Output }],
    containerRef: [{ type: i0.ViewChild, args: [i0.TemplateRef, { read: i0.ViewContainerRef, static: true },] }]
};
...
NbCalendarYearCellComponent.propDecorators = {
    ...
    disabled: [{ type: i0.HostBinding, args: ['class.disabled',] }],
    isLarge: [{ type: i0.HostBinding, args: ['class.size-large',] }],
    yearCellClass: [{ type: i0.HostBinding, args: ['class.year-cell',] }],
    onClick: [{ type: i0.HostListener, args: ['click',] }]
};
...
class NbNativeDateService extends NbDateService {
    ...
    getMonthName(date, style$$1 = _angular_common.TranslationWidth.Abbreviated) {
        const index = date.getMonth();
        return this.getMonthNameByIndex(index, style$$1);
    }
    getMonthNameByIndex(index, style$$1 = _angular_common.TranslationWidth.Abbreviated) {
...
NbBaseCalendarComponent.propDecorators = {
    ...
    size: [{ type: i0.Input }],
    visibleDate: [{ type: i0.Input }],
    showNavigation: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.has-navigation',] }],
    date: [{ type: i0.Input }],
    showWeekNumber: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.has-week-number',] }],
    weekNumberSymbol: [{ type: i0.Input }],
    dateChange: [{ type: i0.Output }],
    large: [{ type: i0.HostBinding, args: ['class.size-large',] }]
};
...
NbCalendarRangeDayCellComponent.propDecorators = {
    ...
    rangeCellClass: [{ type: i0.HostBinding, args: ['class.range-cell',] }],
    dayCellClass: [{ type: i0.HostBinding, args: ['class.day-cell',] }],
    today: [{ type: i0.HostBinding, args: ['class.today',] }],
    boundingMonth: [{ type: i0.HostBinding, args: ['class.bounding-month',] }],
    selected: [{ type: i0.HostBinding, args: ['class.selected',] }],
...
NbCalendarRangeYearCellComponent.propDecorators = {
    ...
    select: [{ type: i0.Output }],
    inRange: [{ type: i0.HostBinding, args: ['class.in-range',] }],
    rangeStart: [{ type: i0.HostBinding, args: ['class.start',] }],
    rangeEnd: [{ type: i0.HostBinding, args: ['class.end',] }],
    selected: [{ type: i0.HostBinding, args: ['class.selected',] }],
    today: [{ type: i0.HostBinding, args: ['class.today',] }],
    disabled: [{ type: i0.HostBinding, args: ['class.disabled',] }],
    isLarge: [{ type: i0.HostBinding, args: ['class.size-large',] }],
...
class NbRestoreScrollTopHelper {
    ...
    shouldRestore() {
        return this.router.events
            .pipe(rxjs_operators.startWith(null), rxjs_operators.filter(event => event === null || event instanceof _angular_router.NavigationEnd), rxjs_operators.pairwise(), rxjs_operators.map(([prev, current]) => this.pageChanged(prev, current)), rxjs_operators.filter(res => !!res));
    }
...
class NbLayoutComponent {
    constructor(themeService, spinnerService, elementRef, renderer, window, document, platformId, layoutDirectionService, scrollService, rulerService, scrollTop, overlayContainer) {
        ...
        this.scrollService
            .onScrollableChange()
            .pipe(rxjs_operators.filter(() => this.withScrollValue))
    ...
    ngAfterViewInit() {
        ...
        this.scrollTop.shouldRestore()
            .pipe(rxjs_operators.filter(() => this.restoreScrollTopValue), rxjs_operators.takeUntil(this.destroy$))
...
NbLayoutComponent.propDecorators = {
    ...
    layoutContainerRef: [{ type: i0.ViewChild, args: ['layoutContainer', { read: i0.ElementRef },] }],
 ...
 * Licensed under the MIT License. See License.txt in the project root for license information.
 */
const itemClick$ = new rxjs.Subject();
const addItems$ = new rxjs.ReplaySubject(1);
const navigateHome$ = new rxjs.ReplaySubject(1);
const getSelectedItem$ = new rxjs.ReplaySubject(1);
const itemSelect$ = new rxjs.ReplaySubject(1);
const itemHover$ = new rxjs.ReplaySubject(1);
const submenuToggle$ = new rxjs.ReplaySubject(1);
const collapseAll$ = new rxjs.ReplaySubject(1);
...
class NbMenuService {
     ...
     */
    getSelectedItem(tag) {
        const listener = new rxjs.BehaviorSubject(null);
...
class NbMenuItemComponent {
    ...
    ngAfterViewInit() {
        this.menuService.onSubmenuToggle()
            .pipe(rxjs_operators.filter(({ item }) => item === this.menuItem), rxjs_operators.map(({ item }) => item.expanded), rxjs_operators.takeUntil(this.destroy$))
            .subscribe(isExpanded => this.toggleState = isExpanded ? exports.NbToggleStates.Expanded : exports.NbToggleStates.Collapsed);
    }
    ngOnDestroy() {
        this.destroy$.next();
        this.destroy$.complete();
...
class NbMenuComponent {
    ...
    ngOnInit() {
        ...
        this.menuInternalService
            .onAddItem()
            .pipe(rxjs_operators.filter((data) => this.compareTag(data.tag)), rxjs_operators.takeUntil(this.destroy$))
        ...
        this.router.events
            .pipe(rxjs_operators.filter(event => event instanceof _angular_router.NavigationEnd), rxjs_operators.takeUntil(this.destroy$))
            .subscribe(() => {
...
NbRouteTabsetComponent.propDecorators = {
    ...
    tabs: [{ type: i0.Input }],
    activeLinkOptions: [{ type: i0.Input }],
...
class NbTabsetComponent {
    ...
    ngAfterContentInit() {
        this.route.params
            .pipe(rxjs_operators.map((params) => this.tabs.find((tab) => this.routeParam ? tab.route === params[this.routeParam] : tab.active)), rxjs_operators.delay(0), rxjs_operators.map((tab) => tab || this.tabs.first), rxjs_operators.filter((tab) => !!tab))
...
NbBadgeComponent.propDecorators = {
    ...
    basic: [{ type: i0.HostBinding, args: ['class.status-basic',] }],
    control: [{ type: i0.HostBinding, args: ['class.status-control',] }],
    top: [{ type: i0.HostBinding, args: ['class.position-top',] }],
    right: [{ type: i0.HostBinding, args: ['class.position-right',] }],
    bottom: [{ type: i0.HostBinding, args: ['class.position-bottom',] }],
    left: [{ type: i0.HostBinding, args: ['class.position-left',] }],
    start: [{ type: i0.HostBinding, args: ['class.position-start',] }],
    end: [{ type: i0.HostBinding, args: ['class.position-end',] }]
};
...
class NbSearchComponent {
    ...
    ngOnInit() {
        ...
        this.searchService.onSearchActivate()
            .pipe(rxjs_operators.filter(data => !this.tag || data.tag === this.tag), rxjs_operators.takeUntil(this.destroy$))
    ...
    openSearch() {
        ...
        rxjs.of(null).pipe(rxjs_operators.delay(0)).subscribe(() => {
    ...
    removeLayoutClasses() {
        ...
        rxjs.of(null).pipe(rxjs_operators.delay(500)).subscribe(() => {
...
NbSearchComponent.propDecorators = {
    ...
    searchButton: [{ type: i0.ViewChild, args: ['searchButton', { read: i0.ElementRef },] }]
};
...
NbCheckboxComponent.decorators = [
  ...
  `,
                providers: [{
                        ...
                        useExisting: i0.forwardRef(() => NbCheckboxComponent),
                        multi: true,
                    }],
                changeDetection: i0.ChangeDetectionStrategy.OnPush,
...
class NbDynamicOverlay {
    ...
    setPositionStrategy(positionStrategy) {
        ...
        this.positionStrategy.positionChange
            .pipe(rxjs_operators.filter(() => !!this.container), rxjs_operators.takeUntil(rxjs.merge(this.positionStrategyChange$, this.destroy$)))
            .subscribe((position) => {
...
class NbDynamicOverlayChange extends i0.SimpleChange {
...
NbPopoverDirective.propDecorators = {
    ...
    trigger: [{ type: i0.Input, args: ['nbPopoverTrigger',] }],
    offset: [{ type: i0.Input, args: ['nbPopoverOffset',] }],
    popoverClass: [{ type: i0.Input, args: ['nbPopoverClass',] }],
    nbPopoverShowStateChange: [{ type: i0.Output }]
};
...
class NbContextMenuDirective {
    ...
    subscribeOnItemClick() {
        this.menuService.onItemClick()
            .pipe(rxjs_operators.filter(({ tag }) => tag === this.tag), rxjs_operators.takeUntil(this.destroy$))
            .subscribe(() => this.hide());
    }
}
...
NbContextMenuDirective.propDecorators = {
    contextMenuHost: [{ type: i0.HostBinding, args: ['class.context-menu-host',] }],
    ...
    items: [{ type: i0.Input, args: ['nbContextMenu',] }],
    trigger: [{ type: i0.Input, args: ['nbContextMenuTrigger',] }],
    contextMenuClass: [{ type: i0.Input, args: ['nbContextMenuClass',] }]
};
...
NbAlertComponent.propDecorators = {
    ...
    closable: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.closable',] }],
    close: [{ type: i0.Output }],
    tiny: [{ type: i0.HostBinding, args: ['class.size-tiny',] }],
    small: [{ type: i0.HostBinding, args: ['class.size-small',] }],
    medium: [{ type: i0.HostBinding, args: ['class.size-medium',] }],
    ...
    basicOutline: [{ type: i0.HostBinding, args: ['class.outline-basic',] }],
    controlOutline: [{ type: i0.HostBinding, args: ['class.outline-control',] }]
};
...
NbChatComponent.propDecorators = {
    ...
    chatForm: [{ type: i0.ContentChild, args: [NbChatFormComponent,] }],
    tiny: [{ type: i0.HostBinding, args: ['class.size-tiny',] }],
    small: [{ type: i0.HostBinding, args: ['class.size-small',] }],
    medium: [{ type: i0.HostBinding, args: ['class.size-medium',] }],
    large: [{ type: i0.HostBinding, args: ['class.size-large',] }],
...
class NbInputDirective {
    constructor(elementRef, focusMonitor, renderer, zone) {
         ...
         * @docs-private
         **/
        this.fullWidth$ = new rxjs.BehaviorSubject(this.fullWidth);
    }
    /**
    ...
    ngOnInit() {
        this.focusMonitor.monitor(this.elementRef)
            .pipe(rxjs_operators.map(origin => !!origin), rxjs_operators.finalize(() => this.focusMonitor.stopMonitoring(this.elementRef)), rxjs_operators.takeUntil(this.destroy$))
...
NbInputDirective.propDecorators = {
    fieldSize: [{ type: i0.Input }],
    status: [{ type: i0.Input }],
    shape: [{ type: i0.Input }],
    fullWidth: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.input-full-width',] }],
    tiny: [{ type: i0.HostBinding, args: ['class.size-tiny',] }],
    small: [{ type: i0.HostBinding, args: ['class.size-small',] }],
    medium: [{ type: i0.HostBinding, args: ['class.size-medium',] }],
    large: [{ type: i0.HostBinding, args: ['class.size-large',] }],
...
const NB_STEPPER = new i0.InjectionToken('Nebular Stepper Component');
...
NbStepComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: i0.Inject, args: [NB_STEPPER,] }] }
];
...
NbStepperComponent.propDecorators = {
    ...
    disableStepNavigation: [{ type: i0.Input }],
 ...
 * Licensed under the MIT License. See License.txt in the project root for license information.
 */
const accordionItemBodyTrigger = _angular_animations.trigger('accordionItemBody', [
...
class NbInfiniteListDirective {
    ...
    ngAfterViewInit() {
        this.scrollService.onScroll()
            .pipe(rxjs_operators.filter(() => this.windowScroll), rxjs_operators.switchMap(() => this.getContainerDimensions()), rxjs_operators.takeUntil(this.destroy$))
        ...
        rxjs_operators.switchMap(() => rxjs.interval(50).pipe(rxjs_operators.filter(() => this.inSyncWithDom()), rxjs_operators.take(1), rxjs_operators.takeUntil(rxjs.timer(1000)))), rxjs_operators.switchMap(() => this.getContainerDimensions()), rxjs_operators.takeUntil(this.destroy$))
            .subscribe(dimentions => this.checkPosition(dimentions));
    ...
    getContainerDimensions() {
        if (this.elementScroll) {
            ...
            return rxjs.of({ scrollTop, scrollHeight, clientHeight });
        }
        return rxjs.forkJoin(this.scrollService.getPosition(), this.dimensionsService.getDimensions())
            .pipe(rxjs_operators.map(([scrollPosition, dimensions]) => ({
...
class NbDirectionality extends _angular_cdk_bidi.Directionality {
}
NbDirectionality.decorators = [
    { type: i0.Injectable }
];

class NbBidiModule extends _angular_cdk_bidi.BidiModule {
}
 ...
 */
class NbCellDefDirective extends _angular_cdk_table.CdkCellDef {
}
NbCellDefDirective.decorators = [
    { type: i0.Directive, args: [{
                selector: '[nbCellDef]',
                providers: [{ provide: _angular_cdk_table.CdkCellDef, useExisting: NbCellDefDirective }],
            },] }
];
/**
 ...
 */
class NbHeaderCellDefDirective extends _angular_cdk_table.CdkHeaderCellDef {
}
NbHeaderCellDefDirective.decorators = [
    { type: i0.Directive, args: [{
                selector: '[nbHeaderCellDef]',
                providers: [{ provide: _angular_cdk_table.CdkHeaderCellDef, useExisting: NbHeaderCellDefDirective }],
            },] }
];
/**
 ...
 */
class NbFooterCellDefDirective extends _angular_cdk_table.CdkFooterCellDef {
}
NbFooterCellDefDirective.decorators = [
    { type: i0.Directive, args: [{
                selector: '[nbFooterCellDef]',
                providers: [{ provide: _angular_cdk_table.CdkFooterCellDef, useExisting: NbFooterCellDefDirective }],
            },] }
];
const NB_SORT_HEADER_COLUMN_DEF = new i0.InjectionToken('NB_SORT_HEADER_COLUMN_DEF');
/**
 * Column definition for the nb-table.
 * Defines a set of cells available for a table column.
 */
class NbColumnDefDirective extends _angular_cdk_table.CdkColumnDef {
}
NbColumnDefDirective.decorators = [
    { type: i0.Directive, args: [{
                selector: '[nbColumnDef]',
                providers: [
                    { provide: _angular_cdk_table.CdkColumnDef, useExisting: NbColumnDefDirective },
                    { provide: NB_SORT_HEADER_COLUMN_DEF, useExisting: NbColumnDefDirective },
                ],
            },] }
];
NbColumnDefDirective.propDecorators = {
    name: [{ type: i0.Input, args: ['nbColumnDef',] }],
    sticky: [{ type: i0.Input }],
    stickyEnd: [{ type: i0.Input }]
};
/** Header cell template container that adds the right classes and role. */
class NbHeaderCellDirective extends _angular_cdk_table.CdkHeaderCell {
...
class NbFooterCellDirective extends _angular_cdk_table.CdkFooterCell {
    constructor(columnDef, elementRef) {
        super(columnDef, elementRef);
        elementRef.nativeElement.classList.add(`nb-column-${columnDef.cssClassFriendlyName}`);
    }
...
class NbCellDirective extends _angular_cdk_table.CdkCell {
    constructor(columnDef, elementRef) {
        super(columnDef, elementRef);
        elementRef.nativeElement.classList.add(`nb-column-${columnDef.cssClassFriendlyName}`);
    }
...
class NbDataSource extends _angular_cdk_table.DataSource {
}

class NbDataRowOutletDirective extends _angular_cdk_table.DataRowOutlet {
}
NbDataRowOutletDirective.decorators = [
    { type: i0.Directive, args: [{
                selector: '[nbRowOutlet]',
                providers: [{ provide: _angular_cdk_table.DataRowOutlet, useExisting: NbDataRowOutletDirective }],
            },] }
];
class NbHeaderRowOutletDirective extends _angular_cdk_table.HeaderRowOutlet {
}
NbHeaderRowOutletDirective.decorators = [
    { type: i0.Directive, args: [{
                selector: '[nbHeaderRowOutlet]',
                providers: [{ provide: _angular_cdk_table.HeaderRowOutlet, useExisting: NbHeaderRowOutletDirective }],
            },] }
];
class NbFooterRowOutletDirective extends _angular_cdk_table.FooterRowOutlet {
}
NbFooterRowOutletDirective.decorators = [
    { type: i0.Directive, args: [{
                selector: '[nbFooterRowOutlet]',
                providers: [{ provide: _angular_cdk_table.FooterRowOutlet, useExisting: NbFooterRowOutletDirective }],
            },] }
];
class NbNoDataRowOutletDirective extends _angular_cdk_table.NoDataRowOutlet {
}
NbNoDataRowOutletDirective.decorators = [
    { type: i0.Directive, args: [{
                selector: '[nbNoDataRowOutlet]',
                providers: [{ provide: _angular_cdk_table.NoDataRowOutlet, useExisting: NbNoDataRowOutletDirective }],
            },] }
];
class NbCellOutletDirective extends _angular_cdk_table.CdkCellOutlet {
}
NbCellOutletDirective.decorators = [
    { type: i0.Directive, args: [{
                selector: '[nbCellOutlet]',
                providers: [{ provide: _angular_cdk_table.CdkCellOutlet, useExisting: NbCellOutletDirective }],
            },] }
];
/**
 ...
 */
class NbHeaderRowDefDirective extends _angular_cdk_table.CdkHeaderRowDef {
}
NbHeaderRowDefDirective.decorators = [
    { type: i0.Directive, args: [{
                selector: '[nbHeaderRowDef]',
                providers: [{ provide: _angular_cdk_table.CdkHeaderRowDef, useExisting: NbHeaderRowDefDirective }],
            },] }
];
NbHeaderRowDefDirective.propDecorators = {
    columns: [{ type: i0.Input, args: ['nbHeaderRowDef',] }],
    sticky: [{ type: i0.Input, args: ['nbHeaderRowDefSticky',] }]
};
/**
 * Footer row definition for the nb-table.
 * Captures the footer row's template and other footer properties such as the columns to display.
 */
class NbFooterRowDefDirective extends _angular_cdk_table.CdkFooterRowDef {
}
NbFooterRowDefDirective.decorators = [
    { type: i0.Directive, args: [{
                selector: '[nbFooterRowDef]',
                providers: [{ provide: _angular_cdk_table.CdkFooterRowDef, useExisting: NbFooterRowDefDirective }],
            },] }
];
NbFooterRowDefDirective.propDecorators = {
    columns: [{ type: i0.Input, args: ['nbFooterRowDef',] }],
    sticky: [{ type: i0.Input, args: ['nbFooterRowDefSticky',] }]
};
/**
 ...
 */
class NbRowDefDirective extends _angular_cdk_table.CdkRowDef {
}
NbRowDefDirective.decorators = [
    { type: i0.Directive, args: [{
                selector: '[nbRowDef]',
                providers: [{ provide: _angular_cdk_table.CdkRowDef, useExisting: NbRowDefDirective }],
            },] }
];
NbRowDefDirective.propDecorators = {
    columns: [{ type: i0.Input, args: ['nbRowDefColumns',] }],
    when: [{ type: i0.Input, args: ['nbRowDefWhen',] }]
};
/** Footer template container that contains the cell outlet. Adds the right class and role. */
class NbHeaderRowComponent extends _angular_cdk_table.CdkHeaderRow {
}
NbHeaderRowComponent.decorators = [
    ...
    <ng-container nbCellOutlet></ng-container>`,
                ...
                providers: [{ provide: _angular_cdk_table.CdkHeaderRow, useExisting: NbHeaderRowComponent }]
            },] }
];
/** Footer template container that contains the cell outlet. Adds the right class and role. */
class NbFooterRowComponent extends _angular_cdk_table.CdkFooterRow {
}
NbFooterRowComponent.decorators = [
    ...
    <ng-container nbCellOutlet></ng-container>`,
                ...
                providers: [{ provide: _angular_cdk_table.CdkFooterRow, useExisting: NbFooterRowComponent }]
            },] }
];
/** Data row template container that contains the cell outlet. Adds the right class and role. */
class NbRowComponent extends _angular_cdk_table.CdkRow {
}
NbRowComponent.decorators = [
    ...
    <ng-container nbCellOutlet></ng-container>`,
                ...
                providers: [{ provide: _angular_cdk_table.CdkRow, useExisting: NbRowComponent }]
            },] }
];
...
class NbTable extends _angular_cdk_table.CdkTable {
...
class NbTableModule extends _angular_cdk_table.CdkTableModule {
}
 ...
 * Licensed under the MIT License. See License.txt in the project root for license information.
 */
const NB_DIALOG_CONFIG = new i0.InjectionToken('Default dialog options');
/**
    ...
    registerCloseListeners(config, overlayRef, dialogRef) {
        ...
        if (config.closeOnEsc) {
            rxjs.fromEvent(this.document, 'keyup')
                .pipe(rxjs_operators.filter((event) => event.keyCode === 27), rxjs_operators.takeUntil(dialogRef.onClose))
 ...
 * Licensed under the MIT License. See License.txt in the project root for license information.
 */
const voidState = _angular_animations.style({
 ...
 * Licensed under the MIT License. See License.txt in the project root for license information.
 */
const NB_TOASTR_CONFIG = new i0.InjectionToken('Default toastr options');
/**
...
NbTooltipDirective.propDecorators = {
    ...
    tooltipClass: [{ type: i0.Input, args: ['nbTooltipClass',] }],
    icon: [{ type: i0.Input, args: ['nbTooltipIcon',] }],
    status: [{ type: i0.Input, args: ['nbTooltipStatus',] }],
    trigger: [{ type: i0.Input, args: ['nbTooltipTrigger',] }],
    nbTooltipShowStateChange: [{ type: i0.Output }]
};
...
const NB_SELECT_INJECTION_TOKEN = new i0.InjectionToken('NB_SELECT_INJECTION_TOKEN');
...
NbOptionComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [NB_SELECT_INJECTION_TOKEN,] }] },
    { type: i0.ElementRef },
    { type: i0.ChangeDetectorRef },
    { type: i0.NgZone },
    { type: i0.Renderer2 }
...
NbOptionComponent.propDecorators = {
    ...
    multiple: [{ type: i0.HostBinding, args: ['class.multiple',] }],
    ...
    onClick: [{ type: i0.HostListener, args: ['click', ['$event'],] }, { type: i0.HostListener, args: ['keydown.space', ['$event'],] }, { type: i0.HostListener, args: ['keydown.enter', ['$event'],] }]
};
...
class NbSelectComponent {
    ...
    ngAfterContentInit() {
        this.options.changes
            .pipe(rxjs_operators.startWith(this.options), rxjs_operators.filter(() => this.queue != null && this.canSelectValue()), rxjs_operators.takeUntil(this.destroy$))
            .subscribe(() => {
    ...
    subscribeOnTriggers() {
        ...
        this.triggerStrategy.hide$
            .pipe(rxjs_operators.filter(() => this.isOpen))
            .subscribe(($event) => {
            this.hide();
    ...
    subscribeOnOptionClick() {
         ...
         * */
        this.options.changes
            .pipe(rxjs_operators.startWith(this.options), rxjs_operators.switchMap((options) => {
            return rxjs.merge(...options.map(option => option.click));
    ...
    subscribeOnOverlayKeys() {
        this.ref.keydownEvents()
            .pipe(rxjs_operators.filter(() => this.isOpen), rxjs_operators.takeUntil(this.destroy$))
            .subscribe((event) => {
    ...
    subscribeOnButtonFocus() {
        this.focusMonitor.monitor(this.button)
            .pipe(rxjs_operators.map(origin => !!origin), rxjs_operators.finalize(() => this.focusMonitor.stopMonitoring(this.button)), rxjs_operators.takeUntil(this.destroy$))
            .subscribe(this.focused$);
    }
    getContainer() {
        return this.ref && this.ref.hasAttached() && {
...
NbSelectComponent.decorators = [
    { type: i0.Component, args: [{
                ...
                providers: [
                    {
                        provide: _angular_forms.NG_VALUE_ACCESSOR,
                        useExisting: i0.forwardRef(() => NbSelectComponent),
                        multi: true,
                    },
...
NbSelectComponent.propDecorators = {
    ...
    button: [{ type: i0.ViewChild, args: ['selectButton', { read: i0.ElementRef },] }],
    isOpen: [{ type: i0.HostBinding, args: ['class.open',] }],
    tiny: [{ type: i0.HostBinding, args: ['class.size-tiny',] }],
    small: [{ type: i0.HostBinding, args: ['class.size-small',] }],
    medium: [{ type: i0.HostBinding, args: ['class.size-medium',] }],
    large: [{ type: i0.HostBinding, args: ['class.size-large',] }],
...
NbOptionListComponent.propDecorators = {
    size: [{ type: i0.Input }],
    position: [{ type: i0.Input }],
    positionTop: [{ type: i0.HostBinding, args: ['class.position-top',] }],
    positionBottom: [{ type: i0.HostBinding, args: ['class.position-bottom',] }],
    sizeTiny: [{ type: i0.HostBinding, args: ['class.size-tiny',] }],
    sizeSmall: [{ type: i0.HostBinding, args: ['class.size-small',] }],
    sizeMedium: [{ type: i0.HostBinding, args: ['class.size-medium',] }],
    sizeLarge: [{ type: i0.HostBinding, args: ['class.size-large',] }],
    sizeGiant: [{ type: i0.HostBinding, args: ['class.size-giant',] }]
};
...
NbAutocompleteComponent.propDecorators = {
    handleDisplayFn: [{ type: i0.Input }],
    size: [{ type: i0.Input }],
    activeFirst: [{ type: i0.Input }],
    selectedChange: [{ type: i0.Output }],
    options: [{ type: i0.ContentChildren, args: [NbOptionComponent, { descendants: true },] }],
    portal: [{ type: i0.ViewChild, args: [NbPortalDirective,] }],
    tiny: [{ type: i0.HostBinding, args: ['class.size-tiny',] }],
...
class NbAutocompleteDirective {
    ...
    subscribeOnOptionClick() {
        ...
        this.autocomplete.options.changes
            .pipe(rxjs_operators.tap(() => this.setActiveItem()), rxjs_operators.startWith(this.autocomplete.options), rxjs_operators.switchMap((options) => {
            return rxjs.merge(...options.map(option => option.click));
        }), rxjs_operators.takeUntil(this.destroy$))
    ...
    subscribeOnTriggers() {
        this.triggerStrategy.show$
            .pipe(rxjs_operators.filter(() => this.isClosed))
            .subscribe(() => this.show());
        this.triggerStrategy.hide$
            .pipe(rxjs_operators.filter(() => this.isOpen))
            .subscribe(() => this.hide());
    ...
    subscribeOnOverlayKeys() {
        this.overlayRef.keydownEvents()
            .pipe(rxjs_operators.takeUntil(this.destroy$))
            .subscribe((event) => {
            if (event.keyCode === _angular_cdk_keycodes.ESCAPE && this.isOpen) {
                event.preventDefault();
                this.hostRef.nativeElement.focus();
                this.hide();
            }
    ...
    checkOverlayVisibility() {
        this.autocomplete.options.changes
            .pipe(rxjs_operators.takeUntil(this.destroy$)).subscribe(() => {
...
NbAutocompleteDirective.decorators = [
    { type: i0.Directive, args: [{
                ...
                providers: [{
                        provide: _angular_forms.NG_VALUE_ACCESSOR,
                        useExisting: i0.forwardRef(() => NbAutocompleteDirective),
                        multi: true,
                    }],
            },] }
];
...
NbAutocompleteDirective.propDecorators = {
    autocomplete: [{ type: i0.Input, args: ['nbAutocomplete',] }],
    focusInputOnValueChange: [{ type: i0.Input }],
    top: [{ type: i0.HostBinding, args: ['class.nb-autocomplete-position-top',] }],
    bottom: [{ type: i0.HostBinding, args: ['class.nb-autocomplete-position-bottom',] }],
    role: [{ type: i0.HostBinding, args: ['attr.role',] }],
    ariaAutocomplete: [{ type: i0.HostBinding, args: ['attr.aria-autocomplete',] }],
    hasPopup: [{ type: i0.HostBinding, args: ['attr.haspopup',] }],
    ...
    handleInput: [{ type: i0.HostListener, args: ['input',] }],
    handleKeydown: [{ type: i0.HostListener, args: ['keydown.arrowDown',] }, { type: i0.HostListener, args: ['keydown.arrowUp',] }],
    handleBlur: [{ type: i0.HostListener, args: ['blur',] }]
};
...
const NB_WINDOW_CONTENT = new i0.InjectionToken('Nebular Window Content');
const NB_WINDOW_CONFIG = new i0.InjectionToken('Nebular Window Config');
const NB_WINDOW_CONTEXT = new i0.InjectionToken('Nebular Window Context');
...
NbWindowsContainerComponent.propDecorators = {
    viewContainerRef: [{ type: i0.ViewChild, args: ['viewContainerRef', { read: i0.ViewContainerRef, static: true },] }]
};
...
class NbWindowService {
    ...
    appendWindow(content, config, windowRef) {
        const context = content instanceof i0.TemplateRef
        ...
        const injector = i0.Injector.create({ parent: parentInjector, providers });
    ...
    subscribeToEvents(windowRef) {
        ...
        if (windowRef.config.closeOnEsc) {
            this.overlayRef.keydownEvents()
                .pipe(rxjs_operators.filter((event) => event.keyCode === 27))
    ...
    checkAndUpdateOverlay() {
        const fullScreenWindows = this.openWindows.filter(w => w.state === exports.NbWindowState.FULL_SCREEN);
...
const NB_DATE_ADAPTER = new i0.InjectionToken('Datepicker Adapter');
const NB_DATE_SERVICE_OPTIONS = new i0.InjectionToken('Date service options');
/**
...
class NbDatepickerDirective {
    ...
    setupPicker() {
        ...
        if (!this.isDatepickerReady) {
            this.picker.init
                .pipe(rxjs_operators.take(1), rxjs_operators.tap(() => this.isDatepickerReady = true), rxjs_operators.filter(() => !!this.queue), rxjs_operators.takeUntil(this.destroy$))
                .subscribe(() => {
                this.writeValue(this.queue);
        ...
        rxjs.merge(this.picker.blur, rxjs.fromEvent(this.input, 'blur').pipe(rxjs_operators.filter(() => !this.picker.isShown && this.document.activeElement !== this.input))).pipe(rxjs_operators.takeUntil(this.destroy$))
    ...
    subscribeOnInputChange() {
        rxjs.fromEvent(this.input, 'input')
            .pipe(rxjs_operators.map(() => this.inputValue), rxjs_operators.takeUntil(this.destroy$))
...
NbDatepickerDirective.decorators = [
    { type: i0.Directive, args: [{
                ...
                providers: [
                    {
                        provide: _angular_forms.NG_VALUE_ACCESSOR,
                        useExisting: i0.forwardRef(() => NbDatepickerDirective),
                        multi: true,
                    },
                    {
...
NbDatepickerContainerComponent.propDecorators = {
    overlayContainer: [{ type: i0.ViewChild, args: [NbOverlayContainerComponent, { static: true },] }]
};
...
class NbBasePicker extends NbDatepicker {
    constructor(overlay, positionBuilder, triggerStrategyBuilder, cfr, dateService, dateServiceOptions) {
         ...
         * */
        this.size = exports.NbCalendarSize.MEDIUM;
        this.init$ = new rxjs.ReplaySubject();
        /**
...
NbBasePickerComponent.ctorParameters = () => [
    ...
    { type: i0.ComponentFactoryResolver },
    { type: NbDateService },
    { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [NB_DATE_SERVICE_OPTIONS,] }] }
];
...
NbRadioComponent.propDecorators = {
    ...
    isPrimary: [{ type: i0.HostBinding, args: ['class.status-primary',] }],
    isSuccess: [{ type: i0.HostBinding, args: ['class.status-success',] }],
    isWarning: [{ type: i0.HostBinding, args: ['class.status-warning',] }],
    isDanger: [{ type: i0.HostBinding, args: ['class.status-danger',] }],
    isInfo: [{ type: i0.HostBinding, args: ['class.status-info',] }],
    isBasic: [{ type: i0.HostBinding, args: ['class.status-basic',] }],
    isControl: [{ type: i0.HostBinding, args: ['class.status-control',] }]
};
...
class NbRadioGroupComponent {
    ...
    subscribeOnRadiosValueChange() {
        ...
        rxjs.merge(...this.radios.map((radio) => radio.valueChange))
            .pipe(rxjs_operators.takeUntil(rxjs.merge(this.radios.changes, this.destroy$)))
            .subscribe((value) => {
            this.writeValue(value);
    ...
    subscribeOnRadiosBlur() {
        ...
        rxjs.fromEvent(hostElement, 'focusin')
            .pipe(rxjs_operators.filter(event => hostElement.contains(event.target)), rxjs_operators.switchMap(() => rxjs.merge(rxjs.fromEvent(this.document, 'focusin'), rxjs.fromEvent(this.document, 'click'))), rxjs_operators.filter(event => !hostElement.contains(event.target)), rxjs_operators.takeUntil(rxjs.merge(this.radios.changes, this.destroy$)))
            .subscribe(() => this.onTouched());
    }
    updateStatus() {
...
NbRadioGroupComponent.decorators = [
    ...
    <ng-content select="nb-radio"></ng-content>`,
                providers: [
                    {
                        provide: _angular_forms.NG_VALUE_ACCESSOR,
                        useExisting: i0.forwardRef(() => NbRadioGroupComponent),
                        multi: true,
                    },
                ],
                changeDetection: i0.ChangeDetectionStrategy.OnPush
...
NbSortDirective.decorators = [
    { type: i0.Directive, args: [{ selector: '[nbSort]' },] }
];
NbSortDirective.propDecorators = {
    sortable: [{ type: i0.Input, args: ['nbSort',] }],
    sort: [{ type: i0.Output }]
};
/**
...
NbSortHeaderIconDirective.decorators = [
    { type: i0.Directive, args: [{ selector: '[nbSortHeaderIcon]' },] }
];
...
NbSortHeaderComponent.ctorParameters = () => [
    ...
    { type: undefined, decorators: [{ type: i0.Inject, args: [NB_SORT_HEADER_COLUMN_DEF,] }] }
];
NbSortHeaderComponent.propDecorators = {
    sortIcon: [{ type: i0.ContentChild, args: [NbSortHeaderIconDirective, { read: i0.TemplateRef },] }],
    direction: [{ type: i0.Input, args: ['nbSortHeader',] }],
    disabled: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.disabled',] }],
    sortIfEnabled: [{ type: i0.HostListener, args: ['click',] }]
};
...
class NbTreeGridDataSource extends NbDataSource {
    constructor(sortService, filterService, treeGridService, treeGridDataService) {
        ...
        this.renderData = new rxjs.BehaviorSubject([]);
        this.filterRequest = new rxjs.BehaviorSubject('');
        this.sortRequest = new rxjs.BehaviorSubject(null);
    }
    ...
    updateChangeSubscription() {
        ...
        const filteredData = rxjs.combineLatest(dataStream, this.filterRequest)
            .pipe(rxjs_operators.map(([data]) => this.treeGridDataService.copy(data)), rxjs_operators.map(data => this.filterData(data)));
        const sortedData = rxjs.combineLatest(filteredData, this.sortRequest)
            .pipe(rxjs_operators.map(([data]) => this.sortData(data)));
        sortedData
            .pipe(rxjs_operators.map((data) => this.treeGridDataService.flattenExpanded(data)))
 ...
 * Licensed under the MIT License. See License.txt in the project root for license information.
 */
const NB_TREE_GRID = new i0.InjectionToken('NB_TREE_GRID');
...
class NbTreeGridComponent extends NbTable {
    ...
    ngAfterViewInit() {
        this.checkDefsCount();
        const rowsChange$ = rxjs.merge(this._contentRowDefs.changes, this._contentHeaderRowDefs.changes, this._contentFooterRowDefs.changes);
        rowsChange$.pipe(rxjs_operators.takeUntil(this.destroy$))
            .subscribe(() => this.checkDefsCount());
        if (this.platform.isBrowser) {
            this.updateVisibleColumns();
            const windowResize$ = rxjs.fromEvent(this.window, 'resize').pipe(rxjs_operators.debounceTime(50));
...
NbTreeGridComponent.propDecorators = {
    source: [{ type: i0.Input, args: ['nbTreeGrid',] }],
    levelPadding: [{ type: i0.Input }],
    equalColumnsWidth: [{ type: i0.Input }],
    treeClass: [{ type: i0.HostBinding, args: ['class.nb-tree-grid',] }]
};

const NbCdkRowDef = _angular_cdk_table.CdkRowDef;
const NbCdkRow = _angular_cdk_table.CdkRow;
const NbCdkCellDef = _angular_cdk_table.CdkCellDef;
const NbCdkHeaderRowDef = _angular_cdk_table.CdkHeaderRowDef;
const NbCdkHeaderRow = _angular_cdk_table.CdkHeaderRow;
const NbCdkHeaderCellDef = _angular_cdk_table.CdkHeaderCellDef;
const NbCdkFooterRowDef = _angular_cdk_table.CdkFooterRowDef;
const NbCdkFooterRow = _angular_cdk_table.CdkFooterRow;
const NbCdkFooterCellDef = _angular_cdk_table.CdkFooterCellDef;
const NbCdkColumnDef = _angular_cdk_table.CdkColumnDef;
const NbCdkCell = _angular_cdk_table.CdkCell;
const NbCdkHeaderCell = _angular_cdk_table.CdkHeaderCell;
const NbCdkFooterCell = _angular_cdk_table.CdkFooterCell;
...
NbTreeGridRowDefDirective.propDecorators = {
    columns: [{ type: i0.Input, args: ['nbTreeGridRowDefColumns',] }]
};
...
NbTreeGridHeaderRowDefDirective.propDecorators = {
    columns: [{ type: i0.Input, args: ['nbTreeGridHeaderRowDef',] }]
};
...
NbTreeGridFooterRowDefDirective.propDecorators = {
    columns: [{ type: i0.Input, args: ['nbTreeGridFooterRowDef',] }]
};
/**
...
class NbTreeGridRowComponent extends NbRowComponent {
    constructor(tree, elementRef) {
        super();
        this.elementRef = elementRef;
        this.doubleClick$ = new rxjs.Subject();
        /**
...
NbTreeGridRowComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: i0.Inject, args: [NB_TREE_GRID,] }] },
    { type: i0.ElementRef }
];
NbTreeGridRowComponent.propDecorators = {
    doubleClickDelay: [{ type: i0.Input }],
    clickToToggle: [{ type: i0.Input }],
    toggleIfEnabledNode: [{ type: i0.HostListener, args: ['click',] }],
    toggleIfEnabledNodeDeep: [{ type: i0.HostListener, args: ['dblclick',] }]
};
...
NbTreeGridColumnDefDirective.propDecorators = {
    name: [{ type: i0.Input, args: ['nbTreeGridColumnDef',] }],
    hideOn: [{ type: i0.Input }],
    showOn: [{ type: i0.Input }]
};
...
class NbTreeGridCellDirective extends NbCellDirective {
    ...
    ngOnInit() {
        ...
        this.columnService.onColumnsChange()
            .pipe(rxjs_operators.filter(() => this.latestWidth !== this.tree.getColumnWidth()), rxjs_operators.takeUntil(this.destroy$))
            .subscribe(() => this.cd.detectChanges());
    }
    ngOnDestroy() {
        this.destroy$.next();
...
NbTreeGridCellDirective.propDecorators = {
    columnWidth: [{ type: i0.HostBinding, args: ['style.width',] }],
    leftPadding: [{ type: i0.HostBinding, args: ['style.padding-left',] }],
    rightPadding: [{ type: i0.HostBinding, args: ['style.padding-right',] }]
};
...
NbFilterDirective.decorators = [
    { type: i0.Directive, args: [{ selector: '[nbFilter]' },] }
];
NbFilterDirective.propDecorators = {
    filterable: [{ type: i0.Input, args: ['nbFilter',] }]
};
/**
...
NbFilterInputDirective.propDecorators = {
    filterable: [{ type: i0.Input, args: ['nbFilterInput',] }],
    debounceTime: [{ type: i0.Input }],
    filter: [{ type: i0.HostListener, args: ['input', ['$event'],] }]
};
...
NbTreeGridRowToggleDirective.propDecorators = {
    toggleRow: [{ type: i0.HostListener, args: ['click', ['$event'],] }]
};
...
NbToggleComponent.decorators = [
  ...
  `,
                providers: [{
                        provide: _angular_forms.NG_VALUE_ACCESSOR,
                        useExisting: i0.forwardRef(() => NbToggleComponent),
                        multi: true,
                    }],
                changeDetection: i0.ChangeDetectionStrategy.OnPush,
...
NbToggleComponent.propDecorators = {
    ...
    basic: [{ type: i0.HostBinding, args: ['class.status-basic',] }],
    control: [{ type: i0.HostBinding, args: ['class.status-control',] }],
    labelLeft: [{ type: i0.HostBinding, args: ['class.toggle-label-left',] }],
    labelRight: [{ type: i0.HostBinding, args: ['class.toggle-label-right',] }],
    labelStart: [{ type: i0.HostBinding, args: ['class.toggle-label-start',] }],
    labelEnd: [{ type: i0.HostBinding, args: ['class.toggle-label-end',] }]
};
...
class NbFormFieldComponent {
    constructor(cd, zone, elementRef, renderer) {
        ...
        this.prefixClasses$ = this.formControlState$.pipe(rxjs_operators.map(s => this.getAddonClasses('prefix', s)));
        this.suffixClasses$ = this.formControlState$.pipe(rxjs_operators.map(s => this.getAddonClasses('suffix', s)));
    }
    ...
    subscribeToFormControlStateChange() {
        ...
        rxjs.combineLatest([disabled$, focused$, size$, status$, fullWidth$])
            .pipe(rxjs_operators.map(([disabled, focused, size, status, fullWidth]) => ({ disabled, focused, size, status, fullWidth })), rxjs_operators.distinctUntilChanged((oldState, state$$1) => this.isStatesEqual(oldState, state$$1)), rxjs_operators.tap(({ size, fullWidth }) => {
...
NbFormFieldComponent.propDecorators = {
    prefix: [{ type: i0.ContentChildren, args: [NbPrefixDirective, { descendants: true },] }],
    suffix: [{ type: i0.ContentChildren, args: [NbSuffixDirective, { descendants: true },] }],
    formControl: [{ type: i0.ContentChild, args: [NbFormFieldControl, { static: false },] }],
    formControlConfig: [{ type: i0.ContentChild, args: [NbFormFieldControlConfig, { static: false },] }],
    formFieldClasses: [{ type: i0.HostBinding, args: ['class',] }]
};
...
exports.NbNoDataRowOutletDirective = NbNoDataRowOutletDirective;
