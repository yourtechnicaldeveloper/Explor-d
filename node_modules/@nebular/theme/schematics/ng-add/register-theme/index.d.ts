 ...
 * */
export declare function registerCustomizableTheme(options: Schema): (tree: Tree) => import("@angular-devkit/schematics/src/tree/interface").Tree;
/**
 * Registers prebuilt css themes by inserting them in the angular.json styles.
 * */
export declare function registerPrebuiltTheme(options: Schema): (tree: Tree) => import("@angular-devkit/schematics/src/tree/interface").Tree;
