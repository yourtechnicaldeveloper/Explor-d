...
const getTsSource = (content: string): ts.SourceFile =>
...
describe('ast utils', () => {
    describe('insert import', () => {
        it('should not import, already imported', () => {
            ...
            const result = insertImport(source, 'MySymbol', 'package');
        ...
        describe('with side effects', () => {
            it('should not import, already imported', () => {
                ...
                const result = insertImport(source, '', 'package');
    ...
    describe('add symbol', () => {
        it('should return noop when no meta is found', () => {
            ...
            const changes = addSymbolToMetadata(source, 'declarations', 'MyComponent');
