...
describe('find-module', () => {
    describe('resolveModule', () => {
        ...
        it('should find a module', () => {
            const foundModule = find_module_1.resolveModule(host, 'foo/src/app/bar');
        ...
        it('should throw if no modules found', () => {
            ...
            try {
                find_module_1.resolveModule(host, 'foo/src/app/bar');
    ...
    describe('findModule', () => {
        ...
        it('should find a module', () => {
            ...
            const modPath = find_module_1.findModule(tree, options);
