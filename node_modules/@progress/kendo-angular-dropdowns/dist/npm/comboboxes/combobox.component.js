...
var ComboBoxComponent = /** @class */ (function () {
    ...
    ComboBoxComponent.prototype.ngOnDestroy = function () {
        ...
        if (util_1.isPresent(this.valueSubscription)) {
            this.valueSubscription.unsubscribe();
        }
    };
    ...
    ComboBoxComponent.prototype.isEmpty = function () {
        var textEmpty = !util_1.isPresent(this.text) || util_1.isEmptyString(this.text);
        var valueEmpty = !util_1.isPresent(this.value) || util_1.isEmptyString(this.value);
    ...
    ComboBoxComponent.prototype.setState = function () {
        ...
        if (util_1.isPresent(resolved.index) && resolved.index !== -1) {
    ...
    ComboBoxComponent.prototype.handleNavigate = function (event) {
        ...
        if (event.keyCode === kendo_angular_common_2.Keys.Home || event.keyCode === kendo_angular_common_2.Keys.End) {
            return;
        }
        if (!hasSelected) {
            if (event.keyCode === kendo_angular_common_2.Keys.ArrowDown) {
                offset = -1;
            }
            else if (event.keyCode === kendo_angular_common_2.Keys.ArrowUp) {
                offset = 1;
            }
        }
    ...
    ComboBoxComponent.prototype.handleEnter = function () {
        ...
        var previousText = util_1.getter(this._previousDataItem, this.textField, this.valuePrimitive) || "";
    ...
    ComboBoxComponent.prototype.handleBlur = function () {
        ...
        var runInZone = valueHasChanged || kendo_angular_common_1.hasObservers(this.onBlur) || kendo_angular_common_1.hasObservers(this.close) || util_1.isUntouched(this.hostElement.nativeElement);
        if (runInZone) {
            this._zone.run(function () {
                if (valueHasChanged) {
                    var lowerCaseMatch = util_1.isPresent(_this.focusedItemText) && _this.focusedItemText.toLowerCase() === currentText.toLowerCase();
    ...
    Object.defineProperty(ComboBoxComponent.prototype, "focusedItemText", {
        get: function () {
            ...
            var itemText = util_1.getter(this.dataService.itemAt(focused), this.textField);
            return !util_1.isPresent(itemText) ? "" : itemText.toString();
        },
        enumerable: true,
        configurable: true
    });
    ...
    ComboBoxComponent.prototype.restoreItemFocus = function () {
        var hasFocus = util_1.isPresent(this.selectionService.focused) && this.selectionService.focused > -1;
