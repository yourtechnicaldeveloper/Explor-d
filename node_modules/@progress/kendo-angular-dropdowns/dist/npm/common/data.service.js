...
var DataService = /** @class */ (function () {
    ...
    Object.defineProperty(DataService.prototype, "itemsCount", {
         ...
         */
        get: function () {
            if (!util_1.isPresent(this.data) || this.data.length === 0) {
                return 0;
            }
    ...
    DataService.prototype.isGrouped = function (data) {
        ...
        return (util_1.isPresent(data) && data.length !== 0) && util_1.isPresent(data[0]) && util_1.hasProps(data[0], ['aggregates', 'field', 'items', 'value']);
    };
    /**
     * @hidden
