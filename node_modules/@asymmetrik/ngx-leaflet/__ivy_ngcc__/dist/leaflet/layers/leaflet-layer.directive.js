...
LeafletLayerDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: LeafletLayerDirective, selectors: [["", "leafletLayer", ""]], inputs: { layer: ["leafletLayer", "layer"] }, features: [ɵngcc0.ɵɵNgOnChangesFeature] });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LeafletLayerDirective, [{
        type: Directive,
        args: [{
                selector: '[leafletLayer]'
            }]
    }], function () { return [{ type: ɵngcc1.LeafletDirective }, { type: ɵngcc0.NgZone }]; }, { layer: [{
            type: Input,
            args: ['leafletLayer']
        }] }); })();
