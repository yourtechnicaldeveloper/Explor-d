...
CategoryListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CategoryListComponent, selectors: [["ngx-category-list"]], decls: 24, vars: 1, consts: [[1, "panel", "panel-primary"], [1, "panel-heading"], [1, "navbar", "navbar-expand-sm", "bg-primary", "navbar-dark"], [1, "navbar-nav"], [1, "nav-item"], [1, "nav-item", "right-btn"], ["routerLink", "../add", "routerLinkActive", "active", 1, "nav-link"], [1, "panel-body"], [1, "table", "table-striped"], [4, "ngFor", "ngForOf"], ["type", "image", 3, "src"], [1, "btn", "btn-info", 3, "routerLink"]], template: function CategoryListComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
