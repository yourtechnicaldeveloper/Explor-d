...
class CreateCategoryComponent {
    constructor(http, router, fb, location) {
        this.http = http;
        this.router = router;
        this.fb = fb;
    ...
    submitForm() {
        ...
        this.http.post('http://18.217.48.28:2000/category/create', formData, { headers: this.getHeader(FormData) }).subscribe((response) => this.refresh(response), (error) => console.log(error));
    }
    refresh(response) {
...
CreateCategoryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CreateCategoryComponent, selectors: [["ngx-create-category"]], decls: 24, vars: 9, consts: [[1, "navbar", "navbar-expand-sm", "bg-primary", "navbar-dark"], [1, "navbar-nav"], [1, "nav-item"], [1, "nav-item", "right-btn"], ["href", "/pages/categories/category-list", "routerlink", "/pages/categories/category-list", "ng-reflect-router-link", "/pages/categories/category-list", 1, "btn", "nav-link"], [2, "width", "500px", "margin", "auto"], [1, "submit-form"], [3, "formGroup", "ngSubmit"], [1, "form-group"], ["for", "icon"], ["type", "file", "name", "icon", 1, "form-control", 3, "ngClass", "change"], ["class", "invalid-feedback", 4, "ngIf"], [1, "form-group", "input-group-lg"], ["for", "name"], ["placeholder", "Name", "formControlName", "name", "name", "name", 1, "form-control", 3, "ngClass"], [1, "btn", "btn-info"], [1, "invalid-feedback"], [4, "ngIf"]], template: function CreateCategoryComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CreateCategoryComponent, [{
    ...
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] }, { type: _angular_common__WEBPACK_IMPORTED_MODULE_4__["Location"] }]; }, null); })();
...
class UpdateCategoryComponent {
    constructor(restService, http, router, route, fb, location, actRoute) {
        this.restService = restService;
        this.http = http;
        this.router = router;
        this.route = route;
    ...
    submitForm() {
        ...
        this.submitted = true;
        if (this.form.valid) {
            this.http.post('http://18.217.48.28:2000/category/categoryUpdate/' + id, formData, { headers: this.getHeader(FormData) }).subscribe((response) => this.refresh(response));
        }
    }
    refresh(response) {
...
UpdateCategoryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UpdateCategoryComponent, selectors: [["ngx-update-category"]], decls: 31, vars: 14, consts: [[1, "navbar", "navbar-expand-sm", "bg-primary", "navbar-dark"], [1, "navbar-nav"], [1, "nav-item"], [1, "nav-item", "right-btn"], ["href", "/pages/categories/category-list", "routerlink", "/pages/categories/category-list", "ng-reflect-router-link", "/pages/categories/category-list", 1, "btn", "nav-link"], [2, "width", "500px", "margin", "auto"], [1, "submit-form"], [3, "formGroup"], [1, "form-group", 3, "hidden"], ["type", "image", 3, "src"], ["for", "icon"], ["type", "file", "name", "icon", 1, "form-control", 3, "change"], [1, "form-group", "input-group-lg", 3, "hidden"], ["for", "name"], ["placeholder", "Name", "formControlName", "name", "disabled", "", "name", "name", 1, "form-control", 3, "ngModel", "ngModelChange"], ["placeholder", "Name", "formControlName", "name", "name", "name", 1, "form-control", 3, "ngModel", "ngClass", "ngModelChange"], ["class", "invalid-feedback", 4, "ngIf"], [1, "form-group"], [1, "btn", "btn-info", 2, "margin-left", "10px", 3, "hidden", "click"], [1, "invalid-feedback"], [4, "ngIf"]], template: function UpdateCategoryComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nav", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "ul", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "li", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "h2");
